...
# Author  : Putramand
# (C) Copyright 2021-2022 By Aliputravip
# =========================================
...
echo -e "         OWNER : ${GREEN} BTR ${NC}${YELLOW}(${NC} ${GREEN} PUTRAMAND  ${NC}${YELLOW})${NC}"
echo -e "       © Copyright By Aliputravip${YELLOW}(${NC} 2022-2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
